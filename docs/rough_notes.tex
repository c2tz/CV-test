...
\usepackage[en-GB,french]{datetime2}
\DTMlangsetup[french]
{showdayofmonth=true}
\DTMsetdatestyle{ddmmyy}  % afficher les dates en format "jj mm aaaa"
\DTMsetup{datesep=.}
\usepackage[
...
\usepackage{fontspec}
\setmainfont{FuturaSansText-Regular.ttf}
\usepackage{ifthen}
...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit\date{\today} - \DTMcurrenttime{}\hspace{\widthof{Dernière mise à jour: Mars 2024}}
    }}}%
  }%
}%
